#!/usr/bin/env python3
"""
Simple ComfyUI Test Script
Process existing test images with ComfyUI oil painting styles
"""
...
def main():
    ...
    print("🎨 ComfyUI Simple Test Processing")
    print("=" * 40)
    ...
    # Check ComfyUI
    processor = SimpleComfyUIProcessor()
    ...
    print(f"🌐 Ready for evaluation at: http://localhost:3001/comfyui-evaluation")
